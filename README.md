...
### Финансовый ассистент для малого бизнеса и ИП, автоматизирующий учёт банковских транзакций

**⚡ Работает в production 3+ года** | **🤖 Продвинутый NLP-алгоритм** | **✅ Open Source**

## 💡 История проекта

CoinCounter создавался для **небольших ИП и собственников бизнеса**, которые не имеют возможности нанять экономиста или платить дорогие подписки за популярные финансовые сервисы (от 1000₽/месяц).

**Проблема:** Ручной учёт транзакций отнимает 2-3 часа каждую неделю, а бесплатные решения не дают нужной аналитики.

**Решение:** Полностью автоматизированная система с AI-категоризацией, работающая на вашем сервере. Все данные под контролем, никаких подписок.
...
- 📅 Автоматическая загрузка банковских транзакций (каждый час)
- 📊 Экспорт новых транзакций в Google Sheets (каждый час)
- 📱 Отправка уведомлений в Telegram (каждый час)
...
> ⚠️ **Внимание:** Использование OpenAI API платное. Проверьте тарифы на https://openai.com/pricing
